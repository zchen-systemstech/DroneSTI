###########################################################################
## Makefile generated for component 'baseline'. 
## 
## Makefile     : baseline.mk
## Generated on : Fri Oct 31 16:01:25 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\baseline.exe
...
COMPILER_COMMAND_FILE     = baseline_comp.rsp
CMD_FILE                  = baseline.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\baseline.exe
...
DEFINES_STANDARD = -DMODEL=baseline -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\baseline_ert_rtw\autocode.cpp
...
{$(START_DIR)\baseline_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\baseline_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\baseline_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\baseline_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
autocode.obj : "$(START_DIR)\baseline_ert_rtw\autocode.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\baseline_ert_rtw\autocode.cpp"
