###########################################################################
## Makefile generated for component 'sig_kadet'. 
## 
## Makefile     : sig_kadet.mk
## Generated on : Thu Oct 30 09:47:46 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\sig_kadet.exe
...
PRODUCT_NAME              = sig_kadet
MAKEFILE                  = sig_kadet.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\zchen\Documents2\Projects\spaaro-main\flight_code\autocode
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
COMPILER_COMMAND_FILE     = sig_kadet_comp.rsp
CMD_FILE                  = sig_kadet.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\sig_kadet.exe
...
DEFINES_STANDARD = -DMODEL=sig_kadet -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\sig_kadet_ert_rtw\autocode.cpp
...
{$(START_DIR)\sig_kadet_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\sig_kadet_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\sig_kadet_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\sig_kadet_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
autocode.obj : "$(START_DIR)\sig_kadet_ert_rtw\autocode.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\sig_kadet_ert_rtw\autocode.cpp"
